...
config :social_crowd_work, SocialCrowdWorkWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Lbw5ni6UfcNHuSfmVrzmW3/P+t9UjGQckDvOfxVWPAeKuUzG+clDHXzv9Lkk2H2s",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:social_crowd_work, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:social_crowd_work, ~w(--watch)]}
  ]
...
config :social_crowd_work, dev_routes: true
