defmodule SocialCrowdWork.Admins.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, SocialCrowdWork.Repo)
  ...
  """
  def valid_password?(%SocialCrowdWork.Admins.Admin{hashed_password: hashed_password}, password)
